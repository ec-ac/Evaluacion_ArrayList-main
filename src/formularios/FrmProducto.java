...
public class FrmProducto extends javax.swing.JFrame {
    ...
    private void jBtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAgregarActionPerformed
        ...
        if("".equals(jTfCodigo.getText()) || jTfCodigo.getText().length() == 0) {
        ...
        if("".equals(jTfNombre.getText()) || jTfNombre.getText().length() == 0) {
        ...
        if("".equals(jTfPrecio.getText()) || jTfPrecio.getText().length() == 0) {
        ...
        if("".equals(jTfExistencia.getText()) || jTfExistencia.getText().length() == 0) {
    ...
    private void jBtnPrimeroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnPrimeroActionPerformed
        ...
        if (!dp.getListProducto().isEmpty()) {
            try {
                ...
                jBtnAgregar.setEnabled(false);  //bloquea agregar
                jBtnEditar.setEnabled(true);    //desbloquea editar
                jBtnEliminar.setEnabled(true);  //desbloquea eliminar
    ...
    private void jBtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEditarActionPerformed
        ...
        jBtnAgregar.setEnabled(true);   //vuelve a desbloquear agregar
        jBtnEditar.setEnabled(false);   //bloquea editar
        jBtnEliminar.setEnabled(false); //bloquea eliminar
